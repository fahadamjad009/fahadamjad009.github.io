...
const PROJECTS = [
  ...
  { id:"nlp2",    code:"// 07", name:"ESG Regulatory Intelligence",  cat:"NLP · ESG",              desc:"Multi-task NLP pipeline for ESG entity extraction, regulatory topic classification, and semantic similarity across sustainability disclosures. BERTopic + custom NER.",                                                                stack:["PyTorch","HuggingFace","BERTopic","NLP","Streamlit"],                   status:"Complete",    sc:"#64FFDA", link:"https://github.com/fahadamjad009/nlp2-esg-regulatory-intelligence",    r:true,  e:true  },
  { id:"nlp3",    code:"// 08", name:"Crypto News Intelligence",     cat:"NLP · Crypto",           desc:"Multi-label classification pipeline tagging crypto news with sentiment, asset tickers, and market impact signals. Real-time ingestion with CoinGecko entity linking. Streamlit dashboard.",                                          stack:["PyTorch","HuggingFace","Multi-label","Streamlit","Python"],             status:"Complete",    sc:"#64FFDA", link:"https://github.com/fahadamjad009/nlp3-crypto-financial-news-intelligence", r:true,  e:true  },
  { id:"bi",      code:"// 09", name:"Financial KPI Command Centre", cat:"BI · Analytics",         desc:"Executive-grade financial intelligence dashboard analysing US large-cap bank quarterly performance. Power BI + Python ETL from SEC EDGAR. DAX measures, waterfall charts, variance analysis.",                                        stack:["Power BI","Python","DAX","SQL","Financial Analytics"],                  status:"Complete",    sc:"#64FFDA", link:"https://github.com/fahadamjad009/bi-financial-kpi-command-centre",      r:true,  e:false },
  { id:"tableau", code:"// 10", name:"ASX Tableau Intelligence",     cat:"BI · Visualisation",     desc:"Nine-sheet Tableau dashboard and published story on ASX sector performance across all 11 GICS sectors. Correlation matrices, rolling returns, earnings seasonality. Live on Tableau Public.",                                        stack:["Tableau","Python","SQL","yfinance"],                                    status:"Deployed",    sc:"#64FFDA", link:"https://github.com/fahadamjad009/asx-tableau-intelligence",          r:true,  e:false },
  { id:"fraud",   code:"// 11", name:"FinTech Fraud Detection",      cat:"FinTech · ML",           desc:"End-to-end fraud detection platform with XGBoost champion model. Cost-sensitive threshold optimisation, Platt scaling calibration, velocity features, merchant risk scores. FastAPI + Streamlit.",                                   stack:["XGBoost","FastAPI","Streamlit","SHAP","scikit-learn"],                  status:"Complete",    sc:"#64FFDA", link:"https://github.com/fahadamjad009/fintech-fraud-detection-platform",      r:true,  e:true  },
  ...
  { id:"idclient",code:"// 15", name:"idclient Platform",            cat:"Identity · TypeScript",  desc:"TypeScript identity client platform for decentralised credential management and verification flows.",                                                                                                                                  stack:["TypeScript","Next.js","PostgreSQL"],                                    status:"In Progress", sc:"#F59E0B", link:"https://github.com/fahadamjad009/idclient-platform",                r:false, e:true  },
];
